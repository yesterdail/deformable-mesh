...
namespace mesheditor.DrawTools
{
  ...
  public class GraphicsRectangle : GraphicsBase
  {
    ...
    public GraphicsRectangle(double left, double top, double right, double bottom, double lineWidth, Color objectColor)
    {
    ...
    public GraphicsRectangle()
      :
      this(0.0, 0.0, 100.0, 100.0, 1.0, Colors.Black)
    {
    }
